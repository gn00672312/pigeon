...
-------------
    ...
    -----------------
        ...
        There are 2 ways to tell 'log' where the configuration should be used.
        They are, in priority, listed below:

        (1) Uses set_log_config() public interface.
        (2) LOG_CONFIG environment.
    ...
    ----------
        ...
        environment variables always got the lowest priority. Here are the
...
-----------------
    ...
    *** set_collective_backup_count(value)
        ...
        these interfaces always got the first priority in precedence.
        ( These function will change property of LogConfigParser/LogStream
          and got the highest order in _determine_log_info and
          _determine_collective_info)
